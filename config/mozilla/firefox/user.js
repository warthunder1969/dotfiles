...
user_pref("reader.parse-on-load.enabled", false); // Disable Firefox speech dispatcher
user_pref("media.webspeech.synth.enabled", false); // Disable Firefox speech dispatcher
