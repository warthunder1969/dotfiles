#!/bin/bash
#Warthunder's SuperProductivity installation script
#Version 1.0
...
This script is for installing SuperProductivity on Debian 
based systems.
...
case $CHOICE in
    ...
    2)
		...
		flatpak install com.super_productivity.SuperProductivity		
		echo "Installed!"
