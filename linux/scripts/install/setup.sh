        ...
        while IFS= read -r profile; do
            case "$profile" in
                "basic")
                    ...
                    #Repository Packages
                    sudo apt install -y git curl wget micro alacritty htop btop nvtop eza nala cmatrix cpufetch fastfetch vlc fonts-noto-color-emoji libfreetype6 fontconfig libcairo2
                    #Flatpaks
